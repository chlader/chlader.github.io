<template>
  <div style="margin-top: 50px;">
    ...
    <div style="display: flex; justify-content: space-evenly; margin-top: 75px;">
      <a href="https://github.com/chlader" target="_blank">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
      ...
      <a href="https://www.linkedin.com/in/ryan-chladek/" target="_blank">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
      ...
      <a href="https://www.facebook.com/ryan.chladek/" target="_blank">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
